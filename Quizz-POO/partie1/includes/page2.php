...
<!--
    ...
    * Page numero 2 (question du quiz, CSS)
   -->
      ...
      */
      ...
      $reponse = new Reponse($requeteQuestion);
       ...
       /*$categorie->getIntitule()[1] represente la premiere categorie 1=Internet et Web
                                                                       ...
                                                                       3= XHTML
      */      
      echo '<h2> II . ' . $categorie->getIntitule()[2] . '</h2>';
      echo '<ul>';
      echo '<form action="index.php?p=page3" method="post">';
      foreach($question->getId() as $valeur1)
      {
          if($question->getCategorie()[$valeur1] == $categorie->getIntitule()[2])
          {                
