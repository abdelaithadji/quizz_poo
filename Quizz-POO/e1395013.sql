...
--
-- Client :  127.0.0.1
-- Généré le :  Lun 23 Juin 2014 à 07:18
...
CREATE TABLE IF NOT EXISTS `question` (
  ...
  `reponse_repondu` int(11) NOT NULL DEFAULT '0',
  `total_repondu` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id_question`),
  UNIQUE KEY `titre_question` (`titre_question`),
  KEY `categorie_question` (`categorie_question`),
  KEY `categorie_question_2` (`categorie_question`)
...
INSERT INTO `question` (`id_question`, `titre_question`, `categorie_question`, `reponse_repondu`, `total_repondu`) VALUES
(1, 'Quel est le protocole de communication de l''''internet?', 'Internet et web', 200, 0),
(2, 'Lequel parmi les protocoles suivants n''''est pas un protocole de communication du web?', 'Internet et web', 400, 0),
(3, 'Lequel parmi les adresses suivants n''''est pas un adresse internet?', 'Internet et web', 180, 0),
(4, 'L''internet et le web sont-ils la meme chose?', 'Internet et web', 260, 0),
(5, 'Que signifie ADSL?', 'Internet et web', 0, 0),
(6, 'Combien Vaut 1MB?', 'Internet et web', 52, 0),
(7, 'Internet Explorer est un ...', 'Internet et web', 58, 0),
(8, 'Que veut dire ''''HTML''''?', 'XHTML', 60, 0),
(9, 'Quel organisme definit les normes pour le web?', 'XHTML', 67, 0),
(10, 'Quelle est la balise correcte pour le titre avec la taille de caractere la plus grande', 'XHTML', 77, 0),
(11, 'Quelle est la balise corecte pour faire un saut de ligne?', 'XHTML', 82, 0),
(12, 'Que fait la balise <blockquote> ?', 'XHTML', 42, 0),
(13, 'Il existe une balise <forme> en XHTML', 'XHTML', 54, 0),
(14, 'Que veut dire ''''CSS''''?', 'CSS', 59, 0),
(15, 'Quel est le code correct pour associer une feuille de style externe dans un fichier HTML?''', 'CSS', 57, 0),
(16, 'A quel endroit dans un fichier HTML faut-il faire référence a une feuille de style externe?', 'CSS', 70, 0),
(17, 'Quelle est la balise HTML pour definir une feuille de style interne?', 'CSS', 64, 0),
(18, 'la balise <STYLE> necessite une balise fermante?', 'CSS', 77, 0);
